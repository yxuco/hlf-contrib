...
const (
	connectorName = "test"
	configFile    = "${GOPATH}/src/github.com/yxuco/hlf-contrib/testdata/config_test.yaml"
	matcherFile   = "${GOPATH}/src/github.com/yxuco/hlf-contrib/testdata/local_entity_matchers.yaml"
	channelID     = "mychannel"
	org           = "org1"
	user          = "User1"
	ccID          = "mycc"
