...
const (
	netConfigPath     = "${GOPATH}/src/github.com/yxuco/hlf-contrib/testdata/config_min.yaml"
	entityMatcherPath = "${GOPATH}/src/github.com/yxuco/hlf-contrib/testdata/local_entity_matchers.yaml"
	user              = "User1"
	org               = "org1"
	channelID         = "mychannel"
